...
namespace MvcTicariOtomasyon.Controllers
{
    ...
    public class IstatistikController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.d9 = deger9;
            var deger10 = c.Uruns.Count(x => x.UrunAd== "Televizyon").ToString();
            ViewBag.d10 = deger10;
            ...
            ViewBag.d12 = deger12;
            var degersatan = c.SatisHarekets.GroupBy(x => x.UrunID).OrderByDescending(z => z.Count()).Select(x => x.Key).FirstOrDefault();
            var deger13 = c.Uruns.Where(x => x.UrunID == degersatan).Select(x => x.UrunAd).FirstOrDefault();
            ViewBag.d13 = deger13;
        ...
        public PartialViewResult PartialÜrün()
        {
